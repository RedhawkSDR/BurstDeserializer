...
pushd cpp
./reconf
%define _bindir %{_prefix}/dom/components/BurstDeserializer/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/%{name}/BurstDeserializer.scd.xml
%{_prefix}/dom/components/%{name}/BurstDeserializer.prf.xml
%{_prefix}/dom/components/%{name}/BurstDeserializer.spd.xml
