# REDHAWK Basic Components BurstDeserializer
 
## Description

Contains the source and build script for the REDHAWK Basic Components BurstDeserializer.
...
REDHAWK Basic Components BurstDeserializer is licensed under the GNU Lesser General Public License (LGPL).
